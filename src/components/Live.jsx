  ...
  return (
    <div className="dark">
      ...
      <Modal open={open} onClose={() => setOpen(false)} title={live.title} wide>
        <div className="flex aspect-video items-center justify-center rounded-[12px] bg-muted">
          <div className="text-center">
            <Broadcast size={44} weight="bold" className="mx-auto text-accent" />
            <p className="mt-[15px] font-roboto text-[15px] text-muted-foreground">Transmissão ao vivo (player integrado ao SuperApp)</p>
            <p className="mt-[4px] font-sora text-[12px] font-bold uppercase tracking-[0.05em] text-accent">{live.viewers} alunos assistindo</p>
          </div>
        </div>
