...
export const TAG_KEYWORDS = {
  ...
  'renda-variavel': ['renda variável', 'bolsa', 'volatilidade', 'day trade', 'swing trade'],
  acoes: ['ação', 'ações', 'ibovespa', 'empresa', 'valuation'],
  ...
  'organizacao-financeira': ['organização financeira', 'planilha', 'orçamento doméstico', 'controle financeiro'],
  'criptomoedas-e-ouro': ['bitcoin', 'cripto', 'criptomoeda', 'ouro', 'blockchain'],
  confissionario: ['confissão', 'anônimo', 'vergonha', 'ninguém sabe'],
  desafios: ['desafio', 'meta de 30 dias', 'sem gastar'],
  'network-profissional': ['network', 'indicação de emprego', 'vaga', 'linkedin'],
  'carreira-e-empreendedorismo': ['carreira', 'empreender', 'empreendedorismo', 'negócio próprio', 'clt', 'pj'],
  'bagunca-terra-livre': ['off-topic', 'zoeira', 'bagunça'],
  vitrine: ['printei', 'print da carteira', 'mostrando o resultado'],
  projetos: ['projeto pessoal', 'side project', 'planilha que criei'],
}
...
export const POSTS = [
  ...
  },
  {
    ...
    flair: 'Dúvida',
    tags: ['tesouro-direto', 'renda-fixa', 'previdencia-privada'],
    turma: 'Turma 40',
    createdAt: daysAgo(2),
    upvotes: 41,
    feed: 'foryou',
  ...
  },
  {
    ...
    flair: 'Dúvida',
    tags: ['previdencia-privada', 'imposto-de-renda', 'planejamento'],
    turma: 'Turma 42',
  ...
  // ── Posts refletindo os canais reais da comunidade AUVP (Discord) ────────
  {
    ...
    flair: 'Dúvida',
    tags: ['criptomoedas-e-ouro', 'internacional', 'planejamento'],
    turma: 'Turma 40',
  ...
  },
  {
    ...
    flair: 'Dúvida',
    tags: ['criptomoedas-e-ouro', 'renda-variavel'],
    turma: 'Turma 43',
  ...
  },
  {
    ...
    flair: 'Case',
    tags: ['organizacao-financeira', 'planejamento', 'projetos'],
    turma: 'Turma 40',
    createdAt: daysAgo(3),
    upvotes: 145,
    feed: 'foryou',
  ...
  },
  {
    ...
    flair: 'Meme',
    tags: ['confissionario', 'bagunca-terra-livre'],
    turma: 'Turma 42',
  ...
  },
  {
    ...
    flair: 'Case',
    tags: ['desafios', 'planejamento', 'organizacao-financeira'],
    turma: 'Turma 42',
  ...
  },
  {
    ...
    flair: 'Dúvida',
    tags: ['network-profissional', 'carreira-e-empreendedorismo'],
    turma: 'Turma 38',
  ...
  },
  {
    ...
    flair: 'Case',
    tags: ['carreira-e-empreendedorismo', 'reserva-de-emergencia', 'planejamento'],
    turma: 'Turma 40',
    createdAt: daysAgo(4),
    upvotes: 203,
    feed: 'foryou',
